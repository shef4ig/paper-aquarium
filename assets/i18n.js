...
(function () {
  ...
  var DICT = {
    ru: {
      ...
      'home.lead': 'Распечатай шаблон, раскрась фломастерами, сфотографируй — и персонажа поплывёт. У каждого ребёнка может быть свой комнат.',
      ...
      'menu.feed.sub': 'персонажи соберутся на корм',
      ...
      'cap.sub': 'Раскрась персонажу на листе, сфотографируй — и она поплывёт в комнате',
      'cap.back': '← в комнат',
