...
// для каждого языка: у комната один адрес, и он должен открываться
// одинаково у всех, кому дали ссылку.
//
// Строки лежат в одном месте на все страницы: комнат, съёмка, раскраски,
...
//   I18N.plural(3, 'fish')               — персонажа / персонажи / рыбок
...
(function () {
  ...
  var DICT = {
    ru: {
      ...
      // ── главная ──
      'home.title': 'Мои комнаты',
      'home.lead': 'Распечатай шаблон, раскрась фломастерами, сфотографируй — и персонажа появится. У каждого ребёнка может быть свой комнат.',
      'home.empty': 'Пока ни одного комната. Создай первый — это займёт секунду.',
      'home.new': 'Новый комнат',
      'home.bycode.title': 'Открыть комнат по коду',
      'home.bycode.hint': 'Код нужен только на новом устройстве — на этом комнаты запоминаются сами. Подойдут и пять цифр из «Открыть на другом экране».',
      ...
      'home.how.demo': '🐠 Посмотреть живой комнат',
      'home.how.demo.sub': 'общая витрина — персонажи уже плавают',
      'home.card.kill': 'Убрать комнат',
      'home.card.empty': 'тут пока пусто',
      'home.terms': 'Правила и данные ↗',
      'terms.back': '← к комнатам',
      'home.footer.important': 'Важно.',
      'home.footer.text': ' Аккаунтов нет: по коду комнат смотрят, по паролю управляют, оба хранит этот браузер. Подробности — в правилах.',

      'home.create.title': 'Новый комнат',
      'home.create.text': 'Назови, чтобы отличать в списке — например, по имени ребёнка.',
      'home.create.value': 'Моя Комната',
      'home.create.ok': 'Создать',
      'home.created.title': 'Моя Комната создан',
      'home.created.text': 'По коду комнат открывают и смотрят, по паролю им управляют. На этом устройстве оба уже сохранены — они всегда под рукой в меню комната, записывать их прямо сейчас не обязательно. Но где-то сохранить стоит: почты и аккаунта тут нет, восстановить их будет негде.',
      'home.created.code': 'Код комната',
      'home.created.pass': 'Пароль',
      'home.created.ok': 'Сохранил, поплыли',
      'home.create.fail.title': 'Моя Комната не создался',
      'home.create.fail.text': 'Похоже, сервер не отвечает. Проверь, запущен ли node server.js.',
      'home.remove.title': 'Убрать «{name}»?',
      'home.remove.text': 'Из списка — комнат останется на сервере, вернёшь его по коду {code}. Совсем — {what} уедут в корзину на сервере, и по коду он больше не откроется.',
      'home.remove.whatEmpty': 'комнат уедет',
      'home.remove.cancel': 'Отмена',
      'home.remove.forget': 'Убрать из моего списка',
      'home.remove.delete': 'Удалить комнат совсем',
      'home.remove.pass.title': 'Пароль от «{name}»',
      'home.remove.pass.text': 'Удалить комнат совсем можно только с паролем. Если пароля нет — убери комнат из своего списка, он останется у хозяина.',
      'home.badcode.title': 'Код не подходит',
      'home.badcode.text': 'Код комната — это ровно 10 символов, буквы и цифры. Проверь, не потерялся ли знак.',

      // ── меню комната ──
      'menu.tank': 'Моя Комната',
      'menu.copied': 'ссылка скопирована',
      'menu.pass': '🔑 пароль',
      'menu.pass.set': '🔓 задать пароль',
      'menu.pass.title': 'Пароль комната',
      'menu.rename.hint': 'Переименовать комнат',
      'menu.close': 'Закрыть меню',
      'menu.back': '← назад',
      'menu.hint': 'нажми в любом месте — покажу меню',
      'menu.capture.title': 'Сфотографировать персонажу',
      'menu.capture.sub': 'раскрашенный лист оживает в комнате',
      'menu.pack.title': 'Запустить готовую персонажу',
      'menu.pack.sub': 'из набора, без раскрашивания',
      'menu.feed.title': 'Поиграть с персонажем',
      'menu.feed.sub': 'персонажи соберутся на мебель',
      'menu.print.title': 'Скачать журнал',
      'menu.print.sub': '12 видов рыбок на обычном листе A4',
      'menu.bg.title': 'Сменить дизайн комнаты',
      'menu.bg.sub': 'картинка, на фоне которой плавают персонажи',
      'menu.fish.title': 'Убрать персонажей',
      'menu.fish.sub': 'удалить лишних из комната',
      'menu.fish.sub.pass': 'удалить лишних — нужен пароль',
      'menu.home.title': 'Мои комнаты',
      'menu.home.sub': 'другие комнаты — и завести новый',
      'menu.picker.title': 'Кого запустить?',
      'menu.picker.sub': 'Персонажа из набора появится в комнате сразу',
      'menu.picker.drawing': 'рисую…',
      'menu.picker.failed': 'не вышло',
      'menu.picker.nopack': 'Набор не собран — запусти tools\\convert-pack.ps1',
      'menu.rename.title': 'Название комната',
      'menu.rename.text': 'Видно только тебе — в списке комнатов и в заголовке этой страницы.',
      'menu.rename.ok': 'Сохранить',
      'menu.rename.fail': 'Не переименовалось',
      'menu.access.title': 'Доступ к комнату',
      'menu.access.text': 'По коду комнат смотрят, по паролю им управляют. Оба сохранены в этом браузере — если почистить его данные, восстановить их будет негде.',
      'menu.access.done': 'Готово',
      'menu.access.change': 'Сменить пароль',
      'menu.newpass.title': 'Новый пароль комната',
      'menu.newpass.first': 'Пароль для комната',
      ...
      'menu.newpass.saved.text': 'Запиши его: восстановить пароль негде. Код комната не менялся — по нему по-прежнему смотрят.',
      ...
      'menu.link.title': 'Ссылка на комнат',
      'tank.doctitle': 'Моя Комната',
      'tank.frame.print': 'Скачать журнал',
      'tank.frame.bg': 'Фон комната',
      'tank.frame.fish': 'Персонажи комната',
      'tank.frame.capture': 'Съёмка персонажи',
      'tank.crash': '<b>Сцена не запустилась</b><br>{msg}',
      'menu.link.text': 'Скопировать сам не смог — забери отсюда. По ней комнат откроется на любом устройстве.',
      'menu.link.ok': 'Готово',
      ...
      'menu.share.hint': 'Наведи камеру телефона — комнат откроется там',
      ...
      'menu.share.pin.text': 'Набери эти цифры на телевизоре — на главной странице, в поле «Открыть комнат по коду». Код живёт 5 минут.',
      'menu.share.pin.fail': 'Код не выдался — попробуй ещё раз',
      // Витрина: общий комнат для знакомства. Меню здесь урезано, чтобы
      // гость не отправил персонажу ребёнка в чужой комнат.
      'demo.title': '🫧 Это витрина',
      'demo.text': 'Общий комнат для знакомства — персонажи тут ничьи. Свои живут в собственном комнате: завести его — секунда, раскраски и съёмка будут там.',
      'demo.own': 'Завести свой комнат',
      'demo.own.sub': 'печать, съёмка и свои персонажи — там',

      'tank.loading': 'Наполняю комнат…',
      'tank.nofish': 'рыбок пока нет',
      'tank.notank': 'Моя Комната не найден — возможно, его удалили или в коде опечатка.',
      'tank.tolist': 'К моим комнатам →',
      'tank.noserver': 'Сервер недоступен. Запусти <code>node server.js</code> и обнови страницу.',
      'tank.nopick': 'Не выбран комнат.',
      'tank.home': 'На главную →',

      // ── съёмка ──
      'cap.title': '🐠 Оживи свою персонажу!',
      'cap.sub': 'Раскрась персонажу на листе, сфотографируй — и она появится в комнате',
      'cap.back': '← в комнат',
      ...
      'cap.searching': 'Ищу персонажу на фото…',
      'cap.reviving': 'персонажа оживает…',
      'cap.release': 'Выпустить в комнат! 🌊',
      'cap.retake': 'Переснять',
      'cap.boost': 'Ярче цвета',
      'cap.done': 'Персонажа уплыла в комнат!',
      ...
      'cap.sending': 'Персонажа плывёт в комнат…',
      ...
      'cap.itis': 'Это {name}!',
      'cap.photo': 'Твоя персонажа',
      'cap.err.nofish': 'Персонажа потерялась — сфотографируй лист заново.',
      ...
      // ── управление ──
      'adm.doctitle': 'Моя Комната — управление персонажами',
      'adm.title': 'управление',
      'adm.tank': 'Моя Комната',
      'adm.capture': 'Съёмка',
      'adm.print': 'Раскраски',
      'adm.home': 'Мои комнаты',
      'adm.pass': 'Пароль:',
      ...
      'adm.fish.del.title': 'Удалить персонажу?',
      'adm.fish.del.pack': 'Она уплывёт из комната. Запустить такую же можно снова в любой момент.',
      'adm.fish.del.painted': 'Рисунок переедет в корзину на сервере — если что, его можно вернуть.',
      'adm.empty': 'В комнате пока нет нарисованных рыбок.',
      'adm.empty.sub': 'Раскрась лист и сфотографируй его с телефона — ссылка «Съёмка» наверху.',
      'adm.clear': 'Удалить всех рыбок',
      'adm.clear.title': 'Очистить комнат?',
      'adm.clear.text': 'Из комната уплывут все персонажи — {n} шт. Рисунки переедут в корзину на сервере, вернуть их можно, но из списка они пропадут.',
      'adm.noserver': 'сервер недоступен — запусти node server.js',
      'adm.gate.title': '🔒 Управление под паролем',
      'adm.gate.text': 'Смотреть комнат можно и без него — пароль нужен, чтобы менять фон, переименовывать и удалять рыбок.',
      'adm.gate.ph': 'пароль',
      'adm.gate.enter': 'Войти',
      'adm.gate.back': '← в комнат',
      ...
      'adm.gate.need': 'Нужен пароль комната.',

      // ── раскраски ──
      'print.title': 'Раскраски — шаблоны для печати',
      'print.home': '← мои комнаты',
      'print.all': 'Печать всех',
      'print.pdf': 'Скачать PDF',
      'print.pdf.file': 'раскраски-комнат.pdf',
      ...
      'print.note2': 'Принтера рядом нет? Скачай все листы одним PDF (кнопка вверху) и отправь туда, где принтер найдётся. А пока запусти в комнат готовую персонажу из меню.',
      'print.nomanifest': 'Не загрузился manifest.json — проверь, что сервер запущен.',

      // ── общее ──
      'pass.ask.title': 'Пароль комната',
      'pass.ask.text': 'Пароль спрашивают только на управление. Смотреть комнат можно и без него.',
      'pass.ask.ph': 'например, 481902',
      'pass.ask.ok': 'Войти',
      'pass.bad.title': 'Пароль не подошёл',
      'pass.bad.text': 'Проверь пароль — тот, что показали при создании комната.',
  ...
  var PLURALS = {
    ru: { fish: ['персонажа', 'персонажи', 'рыбок'] },
  ...
  // Соседние вкладки и врезки внутри меню комната: язык поменяли в одном
